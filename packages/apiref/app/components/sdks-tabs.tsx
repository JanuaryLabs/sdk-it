        ...
        >
          {tabs.map((tab) => (
            <TabsTrigger
              key={tab.value}
              value={tab.value}
              className="data-[state=active]:after:bg-primary relative gap-x-1 overflow-hidden rounded-none py-2 text-white after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-0.5 data-[state=active]:bg-inherit data-[state=active]:text-[#99FFE4] data-[state=active]:shadow-none"
            >
