 ...
 */
export type Description = ComplexDescription | string | null;
/**
...
interface VariableCommon {
  ...
  value?: any;
  /** A variable may have multiple types. */
  type?: 'string' | 'boolean' | 'any' | 'number';
  /** Variable name */
  name?: string;
  /** Variable description */
  description?: Description;
  /** When true, indicates this variable was set by Postman */
  system?: boolean;
  disabled?: boolean;
}

/**
 * A Variable must have at least an `id` or a `key` (or both).
 */
export type Variable =
  | (VariableCommon & { id: string; key?: string })
  | (VariableCommon & { key: string; id?: string });
/**
...
export type Url = ComplexUrl | string;
/**
