...
const defaultIconMap: TreeViewIconMap = {
  ...
  folder: <Folder className="text-primary/80 h-4 w-4" />,
};
                  ...
                  {showAccessRights && (
                    ...
                    >
                      {getCheckState(item, itemMap) === 'checked' && (
                        <div className="bg-primary border-primary flex h-4 w-4 items-center justify-center rounded border">
                          <svg
  ...
  return (
    <div className="flex gap-4">
      <div ref={treeRef}>
          ...
          <AnimatePresence mode="wait">
            {selectedIds.size > 0 ? (
              <motion.div
                ...
                exit={{ opacity: 0, y: -20 }}
                className="bg-background flex h-10 items-center justify-between rounded-lg border px-4"
              >
                <div
        ...
        <div
          ref={dragRef}
          className={cn('relative rounded-lg select-none', className)}
