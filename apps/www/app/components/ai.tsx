...
import { useScrollToBottom } from '../shadcn/lib/hooks/use-scroll-to-bottom';
import {
  Credenza,
  CredenzaBody,
  CredenzaContent,
  ...
  return (
    <Credenza open={open} onOpenChange={setOpen}>
      ...
      <CredenzaContent className="gap-0 sm:max-w-xl xl:max-w-4xl">
        ...
        <CredenzaBody>
          <div className="prose-sm prose-p:my-1 prose-ol:my-1 mx-auto w-full text-sm">
            <div className="flex h-full max-h-[calc(100vh-10rem)] flex-col overflow-auto px-8 lg:max-h-[calc(100vh-15rem)]">
              <div className="mt-4 mb-4 flex h-full flex-col items-start">
...
export function ChatList(
  ...
  return (
    <div
      ...
      className="overflow-y-scrollrelative flex min-w-0 flex-1 flex-col gap-2"
    >
