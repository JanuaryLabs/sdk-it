        ...
        >
          ...
          {availableLanguages.map((it) => (
            <TabsTrigger
              key={it.lang}
              value={it.lang}
              className="font-rubik relative min-w-32 cursor-pointer gap-x-1 overflow-hidden rounded-none py-2 font-normal capitalize after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-0.5 data-[state=active]:bg-white/10 data-[state=active]:shadow-none"
            >
              {it.icon}
              {it.lang}
            </TabsTrigger>
